...
function mouseOver(event) { event.target.style.backgroundColor = "#90caf9"; }

function mouseOut(event) { event.target.style.backgroundColor = "#64b5f6"; }
...
function setupHoverAndClick() {
    for(var i = 0; i < cells.length; i++) {
        ...
        cells[i].style.backgroundColor = "#64b5f6";
    }
}
function newGame() {
    for(var i = 0; i < cells.length; i++) {
